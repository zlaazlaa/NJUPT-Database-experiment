...
<template>
  <el-container>
    <div class="ticket">
      ...
      <!-- 新增或修改弹窗 -->
      <div class="dialog">
        <el-dialog title="新增或修改票务信息" :visible.sync="dialogVisible" :before-close="handleClose" width="50%">
          <!-- 表单 -->
          <div class="form">
            <el-form :model="form" :rules="rules" ref="form" label-width="100px">
              <!-- 航班号 -->
              <el-form-item label="航班号" prop="flightNumber">
                <el-input v-model="form.flightNumber" placeholder="请输入航班号" clearable>
                </el-input>
              </el-form-item>
              <!-- 起点 -->
              <el-form-item label="起点" prop="departure">
                <el-input v-model="form.departure" placeholder="请输入起点" clearable>
                </el-input>
              </el-form-item>
              <!-- 终点 -->
              <el-form-item label="终点" prop="destination">
                <el-input v-model="form.destination" placeholder="请输入终点" clearable>
                </el-input>
              </el-form-item>
              <!-- 起飞时刻 -->
              <el-form-item label="起飞时刻" prop="departureTime">
              ...
              <!-- 剩余座位数 -->
              <el-form-item label="剩余座位数" prop="availableSeats">
                <el-input-number v-model="form.availableSeats" :min=0 :max=200 controls-position=right placeholder=0>
                </el-input-number>
              </el-form-item>
              <!-- 票价 -->
              <el-form-item label="票价" prop="price">
                <el-input-number v-model="form.price" :min=0 :max=10000 controls-position=right placeholder=0>
                </el-input-number>
              </el-form-item>
              <!-- 折扣票价 -->
              <el-form-item label="折扣票价" prop="discountPrice">
                <el-input-number v-model="form.discountPrice" :min=0 :max=10000 controls-position=right placeholder=0>
                </el-input-number>
              </el-form-item>
              <!-- 折扣率 -->
              <el-form-item label="折扣率" prop="discountRate">
                <el-input-number v-model="form.discountRate" :min=0 :max=1 :step=0.01 controls-position=right
                  placeholder=0>
                </el-input-number>
              </el-form-item>
              <!-- 航班所属航空公司 -->
              <el-form-item label="航班所属航空公司" prop="airline">
                <el-select v-model="form.airline" placeholder="请选择航班所属航空公司">
                  <el-option label="中国国际航空" value="中国国际航空">
                  </el-option>
                  <el-option label="中国南方航空" value="中国南方航空">
                  </el-option>
                  <el-option label="中国东方航空" value="中国东方航空">
                  </el-option>
